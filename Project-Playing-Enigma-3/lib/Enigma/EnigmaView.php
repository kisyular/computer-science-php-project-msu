...
HTML;
		...
		foreach($keys as $l) {
            ...
            $html .= <<<HTML
<div class="key key-$l">
<img src="images/key.png" alt="$l1 Key">
<button name="key" value="$l1"><span>$l1</span></button>
</div>
<div class="light light-$l">$l1</div>
HTML;
        }
...
<div class="dialog">
<p><button type="submit" name="reset" value="reset">Reset</button></p>
</div>
</form>
</div>
HTML;
